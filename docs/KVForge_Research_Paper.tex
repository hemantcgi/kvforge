...
Index -> KV Pre-compute -> [Phase 1]
     ...
     -> LoRA Train (round 2) -> KV Recompute -> PRS Eval -> [Phase 3]
        ^_________________continuous improvement loop_________________^
\end{lstlisting}
...
\begin{thebibliography}{99}
  ...
  \bibitem{ref5} Karpukhin, V., O\u{g}uz, B., Min, S., Lewis, P., Wu, L., Edunov, S., ... \& Yih, W. T. (2020). Dense Passage Retrieval for Open-Domain Question Answering. *EMNLP 2020.* arXiv:2004.04906
