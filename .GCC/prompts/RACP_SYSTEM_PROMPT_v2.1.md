...
response text so ThinkStack can capture it:

    <thinkstack:commit message="why you chose this approach and what 
...
external APIs, security, or config), also emit:
    ...
    <thinkstack:sensitivity concept="area_name" 
...
[ThinkStack Θ — top concepts]. Respect any invariant constraints (I1, I3).
